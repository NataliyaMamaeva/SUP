...
namespace ERP
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            //    using (var scope = app.Services.CreateScope())
            //    {
            //        Console.WriteLine("SeedBossUserAsync(services);");
            //        var services = scope.ServiceProvider;
            //        SeedBossUserAsync(services);
            //    }



            //    async Task SeedBossUserAsync(IServiceProvider services)
            //    {
            //        var userManager = services.GetRequiredService<UserManager<ErpUser>>();
            //        var roleManager = services.GetRequiredService<RoleManager<IdentityRole>>();
            ...
            //        const string bossName = "Наталия Дмитриевна Мамаева";
            //        const string bossPassword = "SecurePassword123!"; // Установите сложный пароль
            //        const string bossRole = "boss";

            //        if (!await roleManager.RoleExistsAsync(bossRole))
            //        {
            //            await roleManager.CreateAsync(new IdentityRole(bossRole));
            //        }
            ...
            //            if (result.Succeeded)
            //            {
            //                await userManager.AddToRoleAsync(bossUser, bossRole);
            //                Console.WriteLine("Первый пользователь 'boss' успешно создан.");
            //            }
            //            else
            //            {
            ...
            //        else
            //        {
            //            Console.WriteLine("Пользователь с указанной почтой уже существует.");
            //        }
            //    }
        }
    }
